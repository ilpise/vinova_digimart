    ...
    >
      ...
      *}
      ...
      {elseif $customer.addresses|count > 0}
        ...
        <p class="add-address">
          <a href="{$new_address_delivery_url}"><i class="material-icons">&#xE145;</i><span>{l s='add new address' d='Shop.Theme.Actions'}</span></a>
        </p>
      ...
      {if !$use_same_address}
        ...
        {else}
          ...
          <p class="add-address">
            <a href="{$new_address_invoice_url}"><i class="material-icons">&#xE145;</i><span>{l s='add new address' d='Shop.Theme.Actions'}</span></a>
          </p>
        {/if}
