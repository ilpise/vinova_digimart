  ...
  <div class="delivery-options-list">
    {if $delivery_options|count}
      ...
      >
          ...
          {block name='delivery_options'}
            <div class="delivery-options">
              {foreach from=$delivery_options item=carrier key=carrier_id name=delivery_option}
                  <div class="row no-gutters delivery-option align-items-center{if $smarty.foreach.delivery_option.last} last{/if}">
                    <div class="col-sm-1">
                    ...
                    <div for="delivery_option_{$carrier.id}" class="col-sm-11 delivery-option-2">
        ...
        <button type="submit" class="continue btn btn-primary pull-right" name="confirmDeliveryOption" value="1">
