              ...
              <ul class="product-images js-modal-product-images">
                {foreach from=$product.images item=image}
                  <li class="thumb-container">
                    <img data-image-large-src="{$image.large.url}" class="thumb js-modal-thumb" src="{$image.small.url}" alt="{$image.legend}" title="{$image.legend}" width="{$image.small.width}" itemprop="image">
                  </li>
                {/foreach}
              </ul>
            </div>
